...
public class PhrasesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        words.add(new Word("What is your name?", "તમારું નામ શું છે?",
                R.raw.phrase_what_is_your_name));
        words.add(new Word("My name is...", "મારું નામ...", R.raw.phrase_my_name_is));
        ...
        words.add(new Word("Are you coming?", "શું તમે આવો છો?", R.raw.phrase_are_you_coming));
